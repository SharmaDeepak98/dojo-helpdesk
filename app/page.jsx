...
export default function Home() {
  return (
    <main>
      ...
      <div className="card">
        <h3>something</h3>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Non nam perspiciatis iure, corrupti mollitia dolorum voluptate quasi, aut consequuntur velit, dolore illo. Neque facilis nulla nemo voluptatibus veniam corrupti ipsam.</p>
      </div>
    </main>
  )
}